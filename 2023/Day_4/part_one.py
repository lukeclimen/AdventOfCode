...
def convert_file_into_array(file_name: typing.Text) -> list:
...
def _split_numbers(input_text: str) -> list[str]:
    """Splits input text into a list containing winning numbers and numbers you
    have"""

    card_number_removed = input_text.split(": ")[-1]
    return card_number_removed.split(" | ")
